...
* **Global Keyboard Shortcuts:** Configure a shortcut (like `Cmd + Space` or `Ctrl + Shift + N`) that instantly opens a blank capture window on your desktop, regardless of what app is currently running.
* **Mobile Widgets:** Place a one-tap capture button on your phone's home screen.
...
### Processing Routines
Capturing is only half the workflow. Left unchecked, your Inbox will become a digital junk drawer. Dedicate 10 minutes at the end of every workday to "process to zero." 
Look at each item in your Inbox and ask:
1. Is this actionable? If yes, move it to your task manager and assign a date.
2. Is this reference material? If yes, move it to the correct folder (Area or Resource) in your knowledge base.
3. Is this trash? If yes, delete it immediately.
...
1. **Empty all inboxes:** Clear your email inbox, computer desktop, downloads folder, and physical notebook. File everything into its proper place in your PIMS.
2. **Review active projects:** Open your task manager. Are there projects that have stalled? Do they need new next-actions defined?
3. **Review waiting-on list:** Follow up on emails you sent or tasks delegated to others that require a response.
4. **Archive the obsolete:** Move completed projects and outdated reference material into your Archive folders. 
5. **Plan the upcoming week:** Look at your calendar and select the 3 to 5 critical tasks that must be accomplished in the week ahead. Time-block them.
