...
1.  **Set up an Inbox:** Create one central location where all quick captures land.
2.  **Define your Current Projects:** Create folders for the 3-5 active projects you are working on right now.
3.  **Process Daily:** Spend 5 minutes at the end of the day moving items from the Inbox into the relevant Project folders or an Archive.
4.  **Link Liberally:** Whenever you mention a concept, wrap it in brackets to create a connection. Do not worry about perfect tagging yet.
